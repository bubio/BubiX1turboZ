...
type
  ...
  MsgId* = enum
    ...
    msgFilterNearest, msgFilterBilinear,
    msgRealtimeMix, msgLightWeightMix, msgVolume, msgShowStatusBar,
    msgHostKeyboard, msgArrowsAsTenkey, msgNumberRowAsTenkey,
...
const
  EnglishCatalog: array[MsgId, string] = [
    ...
    msgFilterNearest: "Filter: Nearest Neighbor",
    msgFilterBilinear: "Filter: Bilinear",
    msgRealtimeMix: "Realtime Mix",
    msgLightWeightMix: "Light Weight Mix",
    msgVolume: "Volume",
    msgShowStatusBar: "Show Status Bar",
    msgHostKeyboard: "Keyboard",
    msgArrowsAsTenkey: "Arrow Keys as Ten-Key",
    msgNumberRowAsTenkey: "Number Row as Ten-Key",
  ...
  JapaneseCatalog: array[MsgId, string] = [
    ...
    msgFilterNearest: "フィルタ: ニアレストネイバー",
    msgFilterBilinear: "フィルタ: バイリニア",
    msgRealtimeMix: "リアルタイムミキシング",
    msgLightWeightMix: "軽量ミキシング",
    msgVolume: "音量",
    msgShowStatusBar: "ステータスバーを表示",
    msgHostKeyboard: "キーボード",
    msgArrowsAsTenkey: "カーソルキーをテンキーとして使う",
    msgNumberRowAsTenkey: "数字キーをテンキーとして使う",
    msgLanguage: "言語",
